(function (factory) {
    ...
    var addLoading = function (container) {
    ...
    var createAmount = function (name, value, unit) {
    ...
    var createGoal = function (name, value) {
        ...
        label.addEventListener("click", function () { this.classList.toggle("active"); });
    ...
    var createEquations = function (elements,fertilizers) {
        var equations = [];
        ...
        /*equation answers*/
    var createAnswers = function (elements, volume) {
        var answers = [];
    ...
    var setElements = function (elements, fertilizers, coefficients, volume) {
        /*clear all*/
    ...
    var setTotals = function (fertilizers,coefficients) {
    ...
    /*total ppm*/
    var setPPM = function (fertilizers, coefficients, volume) {
        var container = document.getElementById("fertilizer-amounts");
        var total = 0;
        coefficients.forEach(function (amount, fertilizerindex) {
            total += amount;
    ...
    var initButtons = function () {
        document.getElementById("fertilizer-add")
        .addEventListener("click", addFertilizer);

        document.getElementById("fertilizer-formula")
        ...
        document.getElementById("npk-add")
        .addEventListener("click", addNPK);

        document.getElementById("npk-formula")
        .addEventListener("keyup", function (event) {
            event.preventDefault();
            if (event.keyCode == 13) {
                addNPK();
        ...
        document.getElementById("goal-add")
        .addEventListener("click", addGoal);

        document.getElementById("goal-element")
        .addEventListener("keyup", function (event) {
            event.preventDefault();
            if (event.keyCode == 13) {
                addGoal();
        ...
        document.getElementById("fertilizer-submit")
        .addEventListener("click", submitEverything);
    };
    var uiInit = function () {
        initOptions();
        initGoals();
