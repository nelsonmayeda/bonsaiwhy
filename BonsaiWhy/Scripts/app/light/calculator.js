...
(function (factory) {
    ...
    var getIncidence = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth) {
    ...
    var getRadDirect = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
    ...
    var getRadReflect = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
        var albedo = .2;
        var rad = .5 * albedo * data.global * (1 - Math.cos(surfaceangle));
        return Math.max(0, rad);
    };
    /*values from 25degree circumsolar table in perez 1990*/
    var getSkyCoefficients = function (cover) {
        if (cover < 1.056) {
    ...
    var getRadSky = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
        var incidenceangle = getIncidence(solaraltitude, solarazimuth, surfaceangle, surfaceazimuth);
        var solarzenith = Math.PI / 2 - solaraltitude;
    ...
    var getRadTotal = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
    ...
    var findOutsideMax = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
        var max = 0;
    ...
    var findInsideMax = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
        var max = 0;
        /*check angle 0-90 degrees*/
        for (var nsurfaceangle = 0; nsurfaceangle <= Math.PI / 2; nsurfaceangle += .1) {
    ...
    var refract = function (solaraltitude, solarazimuth, surfaceangle, surfaceazimuth, data) {
    ...
    var calculateInside = function (sunaltitude, sunazimuth, surfaceangle, surfaceazimuth, data) {
    ...
    var calculateOutside = function (sunaltitude, sunazimuth, surfaceangle, surfaceazimuth, data) {
