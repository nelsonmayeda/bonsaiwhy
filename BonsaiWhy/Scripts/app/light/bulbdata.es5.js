...
(function (factory) {
    ...
    return {
        ...
        bulbs: [{
            label: "55W CFL",
            data: [[52, 50, 31], [26, 25, 17], [12, 12, 7]]
        }, {
            label: "4x54w T5HO",
            data: [[380, 240, 170], [240, 120, 80], [140, 80, 70]]
        }, {
            label: "90W LED",
            data: [[485, 110, 9], [248, 112, 17], [140, 89, 24]]
        }, {
            label: "200W LED",
            data: [[825, 296, 14], [375, 220, 50], [216, 161, 73]]
        }, {
            label: "325W LED",
            data: [[1419, 455, 60], [622, 340, 109], [354, 242, 114]]
        }, {
            label: "650W LED",
            data: [[1820, 1033, 198], [1024, 702, 268], [652, 490, 260]]
        }, {
            label: "800W LED",
            data: [[1942, 1220, 194], [1265, 875, 270], [857, 665, 307]]
        }]
    };
});
